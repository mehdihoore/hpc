    ...
    <div class="stage-sections">
            ...
            <div class="form-group">
                ...
                <select name="overall_status">
                    <option value="Pending" ${
                      ...
                      history.overall_status === "Pending"
                        ? "selected"
                        : ""
                    }>در انتظار</option>
                    <option value="OK" ${
                      history.overall_status === "OK" ? "selected" : ""
                    }>تایید</option>
                    <option value="Reject" ${
                      history.overall_status === "Reject" ||
                      history.overall_status === "Not OK"
                        ? "selected"
                        : ""
                    }>رد</option>
                    <option value="Repair" ${
                      history.overall_status === "Repair" ? "selected" : ""
                    }>نیاز به تعمیر</option>
                </select>
            </div>
            <div class="form-group"><label>تاریخ بازرسی:</label><input type="text" name="inspection_date" value="${
              history.inspection_date_jalali || ""
            }" data-jdp readonly></div>
            <div class="form-group"><label>یادداشت:</label><textarea name="notes">${
              history.notes || ""
            }</textarea></div>
        ...
        <fieldset class="contractor-section">
            ...
            <div class="form-group">
                ...
                <select name="contractor_status">
                    <option value="Pending" ${
                      ...
                      history.contractor_status === "Pending"
                        ? "selected"
                        : ""
                    }>در حال اجرا</option>
                    <option value="Ready for Inspection" ${
                      history.contractor_status === "Ready for Inspection"
                        ? "selected"
                        : ""
                    }>آماده</option>
                </select>
            ...
            <div class="form-group"><label>تاریخ اعلام:</label><input type="text" name="contractor_date" value="${
              history.contractor_date_jalali || ""
            }" data-jdp readonly></div>
            <div class="form-group"><label>توضیحات:</label><textarea name="contractor_notes">${
            ...
            return `<div id="stage-content-${
              ...
              i === 0 ? "active" : ""
            }"><div class="checklist-items">${items}</div>${stageFooter}</div>`;
          })
          .join("");
