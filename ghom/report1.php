...
if (!in_array($_SESSION['role'], ['admin', 'supervisor', 'user'])) {
    http_response_code(403);
    die("Access Denied.");
}
$pageTitle = "داشبورد و گزارشات جامع پروژه";
