...
$report_key = 'save_stands_assignments'; // HARDCODED FOR THIS FILE
...
try {
    ...
    logError("DB Connection failed in {$expected_project_key}/api/save_stands_assignments.php: " . $e->getMessage());
