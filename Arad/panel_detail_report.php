...
try {
    ...
    $stmt = $pdo->prepare("
        SELECT
            hp.*,
            ft.formwork_type as formwork_type_name, -- Renamed to avoid conflict if 'type' exists in hp
        ...
        FROM hpc_panels hp
        LEFT JOIN available_formworks ft ON hp.formwork_type = ft.formwork_type -- Join on formwork_type if it's the FK reference
