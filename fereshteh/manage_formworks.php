...
<div class="container mx-auto px-4 py-8">
    ...
    <?php if (isset($_GET['error'])): ?>
        ...
        if ($_GET['error'] == 5) $errMsg = "شما مجوز لازم برای انجام این عملیات را ندارید."; // <<< Add new error message
        ?>
        <div class="mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded flex items-center">
            ...
            <div><?php echo $errMsg; ?> لطفاً دوباره امتحان کنید یا با مدیر سیستم تماس بگیرید.</div>
        </div>
    <?php endif; ?>
